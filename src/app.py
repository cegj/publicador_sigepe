...
class Application:
    ...
    def checkConnection(self):
      try:
        ...
        messagebox.showerror(f"{ac.AppConfig.nome} {ac.AppConfig.versao}", "Não foi possível estabelecer uma conexão com o Sigepe. Verifique a sua conexão com a internet e tente novamente.")
        sys.exit() 
