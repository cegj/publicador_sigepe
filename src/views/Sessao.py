...
class Sessao(i.Interfaces):
  ...
  def sessao(self):
    ...
    self.handleFieldState("tipo_assinatura", "manual", "orgaoInput")
    s_up.Upag(self, self.linha6c1)
    self.handleFieldState("tipo_assinatura", "manual", "upagInput")
    s_uo.Uorg(self, self.linha6c1)
    self.handleFieldState("tipo_assinatura", "manual", "uorgInput")
    s_ra.ResponsavelAssinatura(self, self.linha7c1)
    s_cr.CargoResponsavel(self, self.linha7c1)
    self.handleFieldState("tipo_assinatura", "manual", "cargoResponsavelInput")
