...
def obter_numero_portaria(textoPortaria):
  ...
  A = textoPortaria.split(configJson['delimitadores']['numero_portaria'][0], 1)
...
def obter_siape(textoPortaria):
  textoPortariaSplit = textoPortaria.split(configJson['delimitadores']['siape'][0], 1)
  matriculaSiape = textoPortariaSplit[1].split(configJson['delimitadores']['siape'][1], 1)
...
def formatar_portaria_para_publicar(textoPortaria):
  ...
  textoPortariaSemCabecalho = textoPortariaSemCabecalho.split(configJson['delimitadores']['preliminar_portaria'][1], 1) #Separa o texto em dois, antes e depois do dois-pontos do cabeçalho

  textoPreliminarPortaria = textoPortariaSemCabecalho[0] + configJson['delimitadores']['preliminar_portaria'][1] #Define parte de cima do texto da portaria
